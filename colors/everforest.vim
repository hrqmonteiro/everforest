...
call everforest#highlight('TelescopePromptPrefix', s:palette.bg, s:palette.none, 'bold')
call everforest#highlight('TelescopePromptNormal', s:palette.bg, s:palette.none, 'bold')
call everforest#highlight('TelescopePromptBorder', s:palette.bg, s:palette.none, 'bold')
