...
call everforest#highlight('NoiceCmdlinePopupTitleLua', s:palette.bg2, s:palette.aqua)
call everforest#highlight('NoiceCmdlinePopupTitleHelp', s:palette.bg2, s:palette.aqua)
