...
" call everforest#highlight('WhichKeyNormal', s:palette.bg_dim, s:palette.bg_dim)
...
call everforest#highlight('TelescopeMatching', s:palette.orange, s:palette.none,)
...
call everforest#highlight('TelescopeResultsTitle', s:palette.bg0, s:palette.bg0)
call everforest#highlight('TelescopeBorder', s:palette.bg0, s:palette.bg0)
call everforest#highlight('TelescopeNormal', s:palette.fg, s:palette.bg0)
...
call everforest#highlight('NoiceCmdlinePopupTitleCmdline', s:palette.bg2, s:palette.aqua)
call everforest#highlight('NoiceCmdlinePopupTitleLua', s:palette.bg2, s:palette.blue)
call everforest#highlight('NoiceCmdlinePopupTitleHelp', s:palette.bg2, s:palette.blue)
